  ...
  List<Movie> _getMockNowPlayingMovies() {
    return [
      ...
      Movie(
        ...
        overview: 'Po is gearing up to become the spiritual leader of his Valley of Peace, but also needs someone to take his place as Dragon Warrior. As such, he will train a new kung fu practitioner for the title and will encounter a villain called the Chameleon who conjures villains from the past.',
        voteAverage: 7.1,
      ...
      Movie(
        ...
        overview: 'Colt Seavers, a battle-scarred stuntman who, having left the business a year earlier to focus on both his physical and mental health, is drafted back into service when the star of a mega-budget studio movie—being directed by his ex, Jody Moreno—goes missing.',
        voteAverage: 7.0,
